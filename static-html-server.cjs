/**
 * Servidor HTML estático extremamente simples
 * Este servidor serve um único arquivo HTML em todas as rotas
 */
...
// Porta para o servidor (5000 é a padrão que o Replit espera)
const PORT = process.env.PORT || 5000;

// HTML completo do site
const HTML = `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
const server = http.createServer((req, res) => {
  ...
  // Enviar o HTML como resposta para qualquer rota
  res.end(HTML);
});

// Iniciar o servidor
try {
  // Garantir que o arquivo .replit.port contém a porta correta

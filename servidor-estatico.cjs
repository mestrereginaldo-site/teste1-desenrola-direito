/**
 * Servidor Web Estático Simples para o Desenrola Direito
 * Este servidor ignora completamente o Vite e o React
 * Formato CommonJS (.cjs) para compatibilidade
 */
...
// Servir pasta public diretamente
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Status informativo no topo da página */
    .status-info {
...
<body>
  <div class="status-info">
    Versão simplificada do site. Estamos trabalhando para melhorar sua experiência.
  </div>
